...
let Modal = () => {
  return (
    <div><div id='exampleModalLive' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='exampleModalLiveLabel' aria-hidden='true'>
        ...
        <div className='modal-content bg-dark text-white'>
          ...
          <div className='row justify-content-center'>
            <h5 className='pt-3 text-center font-weight-bold' id='exampleModalLiveLabel'>Codex Camp</h5>
              ...
              <div className='col-sm-8 left-nb'>
    ...
    <div id='privacy' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='exampleModalLiveLabel' aria-hidden='true'>
      ...
      <div id='kotton' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='exampleModalLiveLabel' aria-hidden='true'>
      <div className='modal-dialog' role='document'>
          <div className='modal-content'>
          <div className='modal-header'>
              <h5 className='modal-title' id='exampleModalLiveLabel'>Modal title</h5>
